...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference('Notification.count') do
      post notifications_url, params: { notification: { content: @notification.content, headline: @notification.headline } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { content: @notification.content, headline: @notification.headline } }
